...
# @camera1Host = "192.168.1.122"  ## Ian's room
# @camera1Port = "80"  ## CHANGE
# @camera1Username = 'viewer' ## CHANGE
# @camera1Password = ENV['CAMERA1_PASSWORD']
# @camera1URL = "/snapshot.cgi"
